...
use Activity\Model\ActivityInviteTable;
    ...
    public function getServiceConfig()
    {
        return array(
			...
			'User\Model\UserTable' =>  function($sm) {
				...
				'Activity\Model\ActivityInviteTable' =>  function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new ActivityInviteTable($dbAdapter);
                    return $table;
                },
				'Activity\Model\ActivityRsvpTable' =>  function($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new ActivityRsvpTable($dbAdapter);
                    return $table;
                },
