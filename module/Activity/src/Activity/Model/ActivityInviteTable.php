   ...
   public function getActivityInvite($group_activity_invite_id)
    ...
    {        
	   $data = array(
			...
			'group_activity_invite_added_date'  => $activity->group_activity_invite_added_date,
			'group_activity_invite_added_ip_address'  => $activity->group_activity_invite_added_ip_address,
