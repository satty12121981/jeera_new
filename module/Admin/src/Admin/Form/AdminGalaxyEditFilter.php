...
class AdminGalaxyEditFilter extends InputFilter
{
    private $dbAdapter;
	...
	$this->add(array(
		...
		'validators' => array(
        	array('name' => 'StringLength', 'options' => array('encoding' => 'UTF-8', 'min' => 1, 'max' => 200,),),
			array('name' => 'Db\NoRecordExists', 'options' => array('table' => 'y2m_group','field' => 'group_seo_title',  'adapter' => $dbAdapter, 'exclude' => array ('field' => 'group_id', 'value' => $id),  'adapter' => $dbAdapter),),                
		),
		));
		...
		'validators' => array(
        	array('name' => 'StringLength', 'options' => array('encoding' => 'UTF-8', 'min' => 1, 'max' => 250000,),),			              
		),
		));	
