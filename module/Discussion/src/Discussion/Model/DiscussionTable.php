...
class DiscussionTable extends AbstractTableGateway
{
    ...
    public function saveDiscussion(discussion $discussion){        
	   $data = array(
			...
			'group_discussion_added_ip_address'  => new \Zend\Db\Sql\Expression("INET_ATON('" . $discussion->group_discussion_added_ip_address . "')"),	
			'group_discussion_modified_timestamp'  => $discussion->group_discussion_modified_timestamp,		
			'group_discussion_modified_ip_address'  => new \Zend\Db\Sql\Expression("INET_ATON('" . $discussion->group_discussion_modified_ip_address . "')")			
        );
